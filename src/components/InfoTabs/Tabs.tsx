...
export default function Tabs() {
  ...
  function changeYoutube(){changeMusic({ youtube: !data.stateMusic.pressBtn.youtube }, '/assets/sounds/nature.wav')};

  function changeFire(){changeMusic({ fire: !data.stateMusic.pressBtn.fire }, '/assets/sounds/fire.wav')};

  function changeWaves(){changeMusic({ waves: !data.stateMusic.pressBtn.waves }, '/assets/sounds/waves.wav')};

  function changeForest(){changeMusic({ forest: !data.stateMusic.pressBtn.forest }, '/assets/sounds/nature.wav')};

  function changeMusic(changeBtn: {}, musicLink: string) {
    let newBtnsObj = data.stateMusic.pressBtn;
    Object.keys(data.stateMusic.pressBtn).forEach((key) => {

...
import { changePressBtn, changeMusicLink, changeIsSelection } from "../Utils/Redux/features/statesMusic-slice";
...
export default function ButtonTabs() {
  ...
  function changeYoutube() {
    ...
    changeMusic({ youtube: true }, require('@assets/sounds/nature.wav'));
  };
  ...
  return (
    <View style={infoStyles.container}>
      ...
      <TouchableOpacity style={infoStyles.buttonsInfo} onPressIn={changeYoutube}>
        ...
        <Text style={{ color: colorsStyle.principal.black }}>Youtube</Text>
      </TouchableOpacity>
    </View >
  );
}

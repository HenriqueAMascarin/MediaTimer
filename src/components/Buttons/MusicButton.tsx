...
export default function MusicButton() {
  ...
  return (
    <TouchableOpacity style={[buttonsStyle.buttons, buttonsStyle.principalButton, { backgroundColor: activeStatus ? colorsStyle.principal.blue : colorsStyle.principal.gray }]} onPress={() => toggleTab()}>

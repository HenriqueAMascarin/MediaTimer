...
export default function TotalTimeText() {
    ...
    return (
        <TextAnimated style={[timerStyle.totalTimeText, { opacity: totalTimeOpacity, color: dataTheme.animatedValues.secondaryColor }]}>{t('totalText')} {hours}:{minutes}:{seconds} </TextAnimated>
    )
}
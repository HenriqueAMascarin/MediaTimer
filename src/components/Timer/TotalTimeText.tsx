...
export default function TotalTimeText() {
    ...
    return (
        <TextAnimated style={[timerStyle.totalTimeText, { opacity: totalTimeOpacity, color: dataTheme.animatedValues.secondaryColor }]}>Total {hours}:{minutes}:{seconds} </TextAnimated>
    )
}